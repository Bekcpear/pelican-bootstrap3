     ...
     $.fn.tipuesearch = function(options) {
          ...
          return this.each(function() {
               ...
               if (set.mode == 'live')
               {
                   ...
                   {
                       xhr.open('GET', tipuesearch_pages[i], false);
                       xhr.onload = function() {
                         if (xhr.status === 200) {
                           var html = xhr.responseHTML;
               ...
               if (set.mode == 'json')
               {
                   xhr.open('GET', set.contentLocation, false);
                   // pay attention the warning in https://xhr.spec.whatwg.org/#the-open()-method
               ...
               function getTipueSearch(start, replace)
               {
                    ...
                    if ((d.match("^\"") && d.match("\"$")) || (d.match("^'") && d.match("'$"))
                     || (d.match("^“") && d.match("”$")) || (d.match("^‘") && d.match("’$"))
                     || (d.match("^「") && d.match("」$")))
                    {
                         standard = false;
                    }
